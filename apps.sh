...
if [[ "$state" == "start" ]]; then
    ...
    if ! pacman -Syu git go fastfetch gimp krita mpv flatpak syncplay libreoffice-fresh whipper godot figlet lutris dolphin-emu retroarch blender handbrake; then
